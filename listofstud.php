...
$sql2 = "SELECT COUNT(`fname`)as admin FROM `prostudent`";
...
<center><h1 class="mt-5" style="color: #fff;">LIST OF STUDENTS</h1></center><hr><br>
<h3 class="text-center"><span class="badge badge-info" style="padding: 2px;"><?php echo  $row2 ['admin']?> Students</span></h3>
