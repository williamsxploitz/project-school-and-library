...
$sql = "SELECT * FROM `proadmin`";
$query = mysqli_query($con,$sql);

$sql2 = "SELECT COUNT(`fname`)as admin FROM `proadmin`";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        ...
        <a class="nav-link" href="admin.php" ><b>Register an Admin </b><span class="sr-only">(current)</span></a>
      </li> 
      <li class="nav-item">
...
<h3 class="text-center"><span class="badge badge-info" style="padding: 2px;"><?php echo  $row2 ['admin']?> Admins</span></h3>
